...
hist(fullData$inning, main = "Histogram of Innings where Missed Calls Occur", xlab = "Inning")
hist(log10(fullData$inning), main = "Histogram of Log10(Innings where Missed Calls Occur)", xlab = "Inning") #answer: data is not normal, use Wilcox test
